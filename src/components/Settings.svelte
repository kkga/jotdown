...
<Sidebar {show} on:close={onClose}>
    <div class={tw`flex(& row) pb-4 items-center space-x-2`}>
        ...
        <div class={tw`space-y-1`}>
            ...
            <p class={tw`text-xs leading-none`}>
                Simple app for jotting things down.
            </p>
        </div>
    </div>
        ...
        <div class={tw`col-span-3`}>
            <ButtonGroup>
                <Button
                    ...
                    active={fontSize === 1}>Small</Button
                >
                <Button
                    fill
                    on:click={() => handleFontSizeChange(2)}
                    active={fontSize === 2}>Medium</Button
                >
            </ButtonGroup>
        </div>
    </div>
    ...
    <div class={tw(groupContainerStyle)}>
        ...
        <div class={tw`col-span-3 flex flex-row space-x-2`}>
            <kbd class={tw(kbdStyle)}>Tab</kbd>
            <kbd class={tw(kbdStyle)}>Shift-Tab</kbd>
        </div>
        <div>Zoom</div>
        <div class={tw`col-span-3 flex flex-row space-x-2`}>
    ...
    <footer class={tw`mt-auto pt-3 dark:(divide-gray-600) space-y-2 text-xs`}>
        ...
        <div>
            Bugs? <Link href="https://github.com/kkga/jotdown/issues"
                >Create an issue</Link
            >.<br />
            Suggestions? <Link
                href="https://github.com/kkga/jotdown/discussions"
